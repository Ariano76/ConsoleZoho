        ...
        public void Leer_Ultimos_48_Meses_CIUDAD_NSE(string Cab, string xPeriodos)
        {
            ...
            {                
                for (int x = 0; x < sdata48Meses_x_Region_NSE.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                {
                    ...
                    Actualizar_BD(NSE_, "%", "SHARE DOLARES", Mercado_, "0. Cosmeticos", "DOLARES (%)","MENSUAL", 
                ...
                using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_NSE_REGION_CATEGORIA"))
                {
                    ...
                    for (int i = 0; i < 10; i++) // LEYENDO LAS FILAS DEL ARRAY
                    {
                        for (int x = 0; x < sdata48Meses_x_NSE_Region_Categoria.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                        {
                            ...
                            Actualizar_BD(NSE_, "%", "SHARE DOLARES", Ciudad_, Mercado, "DOLARES (%)", "MENSUAL", 
                                Periodo, valor_1, int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                        }
                    }
                }
                    ...
                    if (contadorTotal == 10)
                    {
                        for (int i = 0; i < contadorTotal; i++) // LEYENDO LAS FILAS DEL ARRAY
                        {
                            for (int x = 0; x < sdata48Meses_x_NSE_Region_Tipo.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                            {
                                ...
                                Actualizar_BD(NSE_, "%", "SHARE DOLARES", Ciudad_, Mercado_, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                ...
                using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_NSE_CATEGORIA"))
                {
                    ...
                    for (int i = 0; i < 5; i++) // LEYENDO LAS FILAS DEL ARRAY
                    {
                        for (int x = 0; x < sdata48Meses_x_NSE_Categoria.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                        {
                            ...
                            Actualizar_BD(NSE_, "%", "SHARE DOLARES", "0. Consolidado", Mercado, "DOLARES (%)", "MENSUAL",
                                Periodo, valor_1, int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                        }
                    }
                }
                    ...
                    if (contadorTotal == 10)
                    {
                        for (int i = 0; i < contadorTotal; i++) // LEYENDO LAS FILAS DEL ARRAY
                        {
                            for (int x = 0; x < sdata48Meses_x_NSE_Tipo.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                            {
                                ...
                                Actualizar_BD(NSE_, "%", "SHARE DOLARES", "0. Consolidado", Mercado_, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                                    int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                            }
                        }
                    }
                ...
                using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_TIPO_REGION_MODALIDAD"))
                {
                    ...
                    for (int i = 0; i < 4; i++) // LEYENDO LAS FILAS DEL ARRAY
                    {
                        for (int x = 0; x < sdata48Meses_x_Tipo_Region_Modalidad.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                        {
                            ...
                            Actualizar_BD(V1, "%", "SHARE DOLARES", Ciudad_, Mercado_, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                                int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                            //******
                            Actualizar_BD(V1_, "%", "SHARE DOLARES", Ciudad_, Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_2,
                                int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                        }
                    }
                }
                ...
                using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_TOTAL_REGION_TIPOS"))
                {
                    ...
                    for (int i = 0; i < 2; i++) // LEYENDO LAS FILAS DEL ARRAY
                    {
                        for (int x = 0; x < sdata48Meses_x_Tipo_Region.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                        {
                            ...
                            Actualizar_BD(V1, "%", "SHARE DOLARES", Ciudad_, "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                                int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                        }
                    }
                }
                ...
                using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_TIPO_MODALIDAD"))
                {
                    ...
                    for (int i = 0; i < 2; i++) // LEYENDO LAS FILAS DEL ARRAY
                    {
                        for (int x = 0; x < sdata48Meses_x_Tipo_Modalidad.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                        {
                            ...
                            Actualizar_BD(V1, "%", "SHARE DOLARES", "0. Consolidado", Mercado_, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                                int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                            //******
                            Actualizar_BD(V1_, "%", "SHARE DOLARES", "0. Consolidado", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_2,
                                int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                        }
                    }
                }

...
namespace BL
{
    public class BL_Gasto_Medio_ML_Marcas
    {
        ...
        public double[,] sdata48Meses_x_Tipo_GMDOLM = new double[30, 50];  // TOTAL POR MARCAS Y TIPO HOGAR/UU
        public double[,] sdata48Meses_x_Tipo_Grupo_GMDOLM = new double[2, 48];  // TOTAL MARCAS Y TIPO UNID HOGAR/UU
        public double[,] sdata48Meses_x_Categoria_GMDOLM = new double[30, 50];  // TOTAL POR MARCAS Y CATEGORIA UNID HOGAR/UU
        public double[,] sdata48Meses_x_Categoria_Grupo_GMDOLM = new double[2, 48];  // TOTAL POR MARCAS Y CATEGORIA UNID HOGAR/UU
        public double[,] sdata48Meses_x_Total_GMDOLM = new double[30, 50];  // TOTAL POR MARCAS Y TOTAL COSMETICOS VALORES
        public double[,] sdata48Meses_x_Total_Grupo_GMDOLM = new double[2, 48];  // TOTAL POR MARCAS Y TOTAL COSMETICOS VALORES
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Tipo(string xPeriodos, int xTipo, String xMoneda)
        {
            string xIdMarca = "";
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_TIPO_3M"))
            {
                int cont = 0;
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Categoria(string xPeriodos, int xCateg, String xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_CATEG_3M"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Total_Cosmeticos(string xPeriodos, String xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_TOTAL_3M"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
        ...
        public void Leer_Ultimos_48_Meses_TIPO_TOTAL(string Cab, string xPeriodos, int xTipo, String xMoneda)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOTAL_TIPO"))
            {
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Tipo_GMDOLM[rows, i] = valor_1;
                        }
                        rows++;
                    }
                }
                ...
                {
                    if (sdata48Meses_x_Tipo_GMDOLM[i, 0].ToString() != "")
                    {
                        V1 = Validar_marca(sdata48Meses_x_Tipo_GMDOLM[i, 0].ToString());
                    }

                    for (int x = 2; x < sdata48Meses_x_Tipo_GMDOLM.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        if (x < 11)
                        {
                        ...
                        if (sdata48Meses_x_Tipo_GMDOLM[i, x] <= 0 ||
                            sdata48Meses_x_Tipo_GMDOLM[i, x].ToString() == null)
                        {
                            valor_1 = 0;
                        }
                        else
            ...
            // GRUPO BELCORP            
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_TOTAL_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Tipo_Grupo_GMDOLM[rows, i] = valor_1;
                        }
                        rows++;
                    }
                }
                ...
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_GMDOLM.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        if (x < 9)
                        {
                        ...
                        if (sdata48Meses_x_Tipo_Grupo_GMDOLM[i, x] <= 0)
                        {
                            valor_1 = 0;
                        }
                        else
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Tipo_Grupo_GMDOLM[rows, i] = valor_1 / 1000000;
                        }
                        rows++;
                    }
                }
        ...
        public void Leer_Ultimos_48_Meses_CATEGORIA_TOTAL(string Cab, string xPeriodos, int xCategoria, String xMoneda)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOTAL_CATEGORIA"))
            {
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Categoria_GMDOLM[rows, i] = valor_1;
                        }
                        rows++;
                    }
                }
                ...
                for (int i = 0; i < rows - 1; i += 2) // LEYENDO LAS FILAS DEL ARRAY
                {
                    V1 = Validar_marca(sdata48Meses_x_Categoria_GMDOLM[i, 0].ToString());
                    for (int x = 2; x < sdata48Meses_x_Categoria_GMDOLM.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        if (x < 11)
                        {
                            Periodo = "0" + (x - 1) + ". " + BD_Zoho.sCabecera48Meses[x - 2];
                        ...
                        if (sdata48Meses_x_Categoria_GMDOLM[i, x] <= 0)
                        {
                            valor_1 = 0;
                        }
                        else
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_TOTAL_CATEGORIA"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Categoria_Grupo_GMDOLM[rows, i] = valor_1;
                        }
                        rows++;
                    }
                }
                ...
                for (int i = 0; i < rows - 1; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Categoria_Grupo_GMDOLM.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        if (x < 9)
                        {
                            Periodo = "0" + (x + 1) + ". " + BD_Zoho.sCabecera48Meses[x];
                        ...
                        if (sdata48Meses_x_Categoria_Grupo_GMDOLM[i, x] <= 0)
                        {
                            valor_1 = 0;
                        }
                        else
        ...
        public void Leer_Ultimos_48_Meses_COSMETICOS_TOTAL(string Cab, string xPeriodos, string xMoneda)
        {
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOTAL_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Total_GMDOLM[rows, i] = valor_1;
                        }
                        rows++;
                    }
                }
                ...
                for (int i = 0; i < rows - 1; i += 2) // LEYENDO LAS FILAS DEL ARRAY
                {
                    V1 = Validar_marca(sdata48Meses_x_Total_GMDOLM[i, 0].ToString());
                    for (int x = 2; x < sdata48Meses_x_Total_GMDOLM.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        if (x < 11)
                        {
                            Periodo = "0" + (x - 1) + ". " + BD_Zoho.sCabecera48Meses[x - 2];
                        ...
                        if (sdata48Meses_x_Total_GMDOLM[i, x] <= 0)
                        {
                            valor_1 = 0;
                        }
                        else
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_TOTAL_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Grupo_Belcorp_3M_Tipo);
                ...
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
                {
                    ...
                    while (reader_1.Read())
                    {
                        for (int i = 0; i < cols; i++) // LEYENDO DESDE LA COLUMNA CON LOS VALORES
                        {
                            ...
                            sdata48Meses_x_Total_Grupo_GMDOLM[rows, i] = valor_1;
                        }
                        rows++;
                    }
                }
                ...
                for (int i = 0; i < rows - 1; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Total_Grupo_GMDOLM.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        if (x < 9)
                        {
                            Periodo = "0" + (x + 1) + ". " + BD_Zoho.sCabecera48Meses[x];
                        ...
                        if (sdata48Meses_x_Total_Grupo_GMDOLM[i, x] <= 0)
                        {
                            valor_1 = 0;
                        }
                        else
        ...
        #region CAPITAL
        public void Recuperar_Marcas_Top_5_Retail_x_Tipo_Capital(string xPeriodos, int xTipo, string xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_TIPO_3M_CAPITAL"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipo);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Categoria_Capital(string xPeriodos, int xCateg, string xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_CATEG_3M_CAPITAL"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xCateg);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Total_Capital(string xPeriodos, string xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_TOTAL_3M_CAPITAL"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
        ...
        public void Leer_Ultimos_48_Meses_TIPO_Capital(string Cab, string xPeriodos, int xTipo, string xMoneda)
        {
            xTipos_ = xTipo.ToString();
            switch (xTipo)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_CAPITAL_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // GRUPO BELCORP            
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_CAPITAL_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_Categoria_Capital(string Cab, string xPeriodos, int xCategoria, string xMoneda)
        {
            xTipos_ = xCategoria.ToString();
            switch (xCategoria)
            {
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_CAPITAL_CATEGORIA"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_CAPITAL_CATEGORIA"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_Cosmeticos_Capital(string Cab, string xPeriodos, string xMoneda)
        {
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_CAPITAL_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Marcas_3M_Total_Cosmeticos);
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_CAPITAL_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Grupo_Belcorp_3M_Tipo);
        ...
        #region REGION
        public void Recuperar_Marcas_Top_5_Retail_x_Tipo_Region(string xPeriodos, int xTipo, string xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_TIPO_3M_REGION"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipo);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Categoria_Region(string xPeriodos, int xCateg, string xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_CATEG_3M_REGION"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xCateg);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Total_Region(string xPeriodos, string xMoneda)
        {
            string xIdMarca = "";
            for (int i = 0; i < Codigo_MARCA_VD.GetLength(0); i++)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_TOP_5_TOTAL_3M_REGION"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
        ...
        public void Leer_Ultimos_48_Meses_TIPO_Region(string Cab, string xPeriodos, int xTipo, string xMoneda)
        {
            xTipos_ = xTipo.ToString();
            switch (xTipo)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_REGION_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // GRUPO BELCORP            
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_REGION_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_Categoria_Region(string Cab, string xPeriodos, int xCategoria, string xMoneda)
        {
            xTipos_ = xCategoria.ToString();
            switch (xCategoria)
            {
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_REGION_CATEGORIA"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_REGION_CATEGORIA"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_Cosmeticos_Region(string Cab, string xPeriodos, string xMoneda)
        {
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_MARCAS_REGION_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Marcas_3M_Total_Cosmeticos);
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("GMDOLM._SP_GRUPO_MARCAS_REGION_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Grupo_Belcorp_3M_Tipo);

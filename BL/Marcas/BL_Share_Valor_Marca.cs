...
namespace BL
{
    public class BL_Share_Valor_Marca
    {              
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Tipo(string xPeriodos, int xTipo)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_TIPO_3M"))
            {
                int cont=0;
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Categoria(string xPeriodos, int xCateg)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_CATEG_3M"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Total_Cosmeticos(string xPeriodos)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_TOTAL_COSMETICOS_3M"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";                
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
        ...
        public void Leer_Ultimos_48_Meses_TIPO_TOTAL(string Cab, string xPeriodos, int xTipo)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                {
                    if (sdata48Meses_x_Tipo_Marcas[i, 0].ToString() != "")
                    {
                    ...
                    for (int x = 1; x < sdata48Meses_x_Tipo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD(V1, "%", "SHARE DOLARES", "0. Consolidado", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("00.Belcorp", "%", "SHARE DOLARES", "0. Consolidado", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("50.Total L'Oreal", "%", "SHARE DOLARES", "0. Consolidado", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("51.Total Estee Lauder", "%", "SHARE DOLARES", "0. Consolidado", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
        ...
        public void Leer_Ultimos_48_Meses_CATEGORIA_TOTAL(string Cab, string xPeriodos, int xCategoria)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_CATEGORIA"))
            {
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_CATEGORIA"))
            {
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_CATEGORIA"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_COSMETICOS_TOTAL(string Cab, string xPeriodos)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_MERCADO"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS"))
            {                
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    ...
                    for (int x = 1; x < sdata48Meses_x_Cosmeticos_Total_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD(V1, "%", "SHARE DOLARES", "0. Consolidado", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x - 1].Substring(0, 4)));
                    }
                }
            }
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Grupo_Belcorp_3M_Tipo);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("00.Belcorp", "%", "SHARE DOLARES", "0. Consolidado", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("50.Total L'Oreal", "%", "SHARE DOLARES", "0. Consolidado", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("51.Total Estee Lauder", "%", "SHARE DOLARES", "0. Consolidado", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Tipo_Capital(string xPeriodos, int xTipo)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_TIPO_3M_Capital"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipo);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Categoria_Capital(string xPeriodos, int xCateg)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_CATEG_3M_Capital"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xCateg);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Total_Cosmeticos_Capital(string xPeriodos)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_TOTAL_COSMETICOS_3M_Capital"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
        ...
        public void Leer_Ultimos_48_Meses_TIPO_TOTAL_CAPITAL(string Cab, string xPeriodos, int xTipo)
        {
            xTipos_ = xTipo.ToString();
            switch (xTipo)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_TIPOS_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    ...
                    for (int x = 1; x < sdata48Meses_x_Tipo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD(V1, "%", "SHARE DOLARES", "1. Capital", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x - 1].Substring(0, 4)));
                    }
                }
            }
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("00.Belcorp", "%", "SHARE DOLARES", "1. Capital", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_CAPITAL"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("50.Total L'Oreal", "%", "SHARE DOLARES", "1. Capital", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_CAPITAL"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("51.Total Estee Lauder", "%", "SHARE DOLARES", "1. Capital", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
        }
        public void Leer_Ultimos_48_Meses_CATEGORIA_TOTAL_CAPITAL(string Cab, string xPeriodos, int xCategoria)
        {
            xTipos_ = xCategoria.ToString();
            switch (xCategoria)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_CATEGORIA_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEGORIA", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_CATEGORIA_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_CATEGORIA_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_COSMETICOS_TOTAL_CAPITAL(string Cab, string xPeriodos)
        {

            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_MERCADO_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Marcas_3M_Total_Cosmeticos);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    ...
                    for (int x = 1; x < sdata48Meses_x_Cosmeticos_Total_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD(V1, "%", "SHARE DOLARES", "1. Capital", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x - 1].Substring(0, 4)));
                    }
                }
            }
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_CAPITAL"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Grupo_Belcorp_3M_Tipo);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("00.Belcorp", "%", "SHARE DOLARES", "1. Capital", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_CAPITAL"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("50.Total L'Oreal", "%", "SHARE DOLARES", "1. Capital", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_CAPITAL"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("51.Total Estee Lauder", "%", "SHARE DOLARES", "1. Capital", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Tipo_Region(string xPeriodos, int xTipo)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_TIPO_3M_Region"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipo);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Categoria_Region(string xPeriodos, int xCateg)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_CATEG_3M_Region"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xCateg);
        ...
        public void Recuperar_Marcas_Top_5_Retail_x_Total_Cosmeticos_Region(string xPeriodos)
        {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_TOP_5_TOTAL_COSMETICOS_3M_Region"))
            {
                int cont = 0;
                string xIdMarcaOtros = "";
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
        ...
        public void Leer_Ultimos_48_Meses_TIPO_TOTAL_REGION(string Cab, string xPeriodos, int xTipo)
        {
            xTipos_ = xTipo.ToString();
            switch (xTipo)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_TIPOS_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    ...
                    for (int x = 1; x < sdata48Meses_x_Tipo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD(V1, "%", "SHARE DOLARES", "2. Ciudades", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x - 1].Substring(0, 4)));
                    }
                }
            }
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_TIPO", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("00.Belcorp", "%", "SHARE DOLARES", "2. Ciudades", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_REGION"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("50.Total L'Oreal", "%", "SHARE DOLARES", "2. Ciudades", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_TIPO_REGION"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Tipo_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("51.Total Estee Lauder", "%", "SHARE DOLARES", "2. Ciudades", Mercado, "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
        }
        public void Leer_Ultimos_48_Meses_CATEGORIA_TOTAL_REGION(string Cab, string xPeriodos, int xCategoria)
        {
            xTipos_ = xCategoria.ToString();
            switch (xCategoria)
            {
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_CATEGORIA_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEGORIA", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_CATEGORIA_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_CATEGORIA_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_CATEG", DbType.String, xTipos_);
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
        ...
        public void Leer_Ultimos_48_Meses_COSMETICOS_TOTAL_REGION(string Cab, string xPeriodos)
        {

            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_SHARE_VALOR_ML_TOTAL_MERCADO_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                using (IDataReader reader_1 = db_Zoho.ExecuteReader(cmd_1))
            ...
            // MARCAS PREDEFINIDAS VD + TOP 5 OTROS
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Marcas_3M_Total_Cosmeticos);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    ...
                    for (int x = 1; x < sdata48Meses_x_Cosmeticos_Total_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD(V1, "%", "SHARE DOLARES", "2. Ciudades", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x - 1].Substring(0, 4)));
                    }
                }
            }
            ...
            // GRUPO BELCORP
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_REGION"))
            {
                db_Zoho.AddInParameter(cmd_1, "_PERIODO", DbType.String, xPeriodos);
                db_Zoho.AddInParameter(cmd_1, "_CABECERA", DbType.String, Cab);
                db_Zoho.AddInParameter(cmd_1, "_MARCAS", DbType.String, Codigo_Grupo_Belcorp_3M_Tipo);
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("00.Belcorp", "%", "SHARE DOLARES", "2. Ciudades", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_REGION"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("50.Total L'Oreal", "%", "SHARE DOLARES", "2. Ciudades", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
            ...
            using (DbCommand cmd_1 = db_Zoho.GetStoredProcCommand("_SP_GRUPO_MARCAS_SHARE_VALOR_ML_TOTAL_COSMETICOS_REGION"))
            {
                ...
                for (int i = 0; i < rows; i++) // LEYENDO LAS FILAS DEL ARRAY
                {
                    for (int x = 0; x < sdata48Meses_x_Cosmeticos_Total_Grupo_Marcas.GetLength(1); x++) //LEYENDO LAS COLUMNAS
                    {
                        ...
                        Actualizar_BD("51.Total Estee Lauder", "%", "SHARE DOLARES", "2. Ciudades", "0. Cosmeticos", "DOLARES (%)", "MENSUAL", Periodo, valor_1,
                            int.Parse(BD_Zoho.sCabecera48Meses[x].Substring(0, 4)));
                    }
                }
            }
